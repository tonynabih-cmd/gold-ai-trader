// risk.js — 24-rule safety gate. Every rule is checked before ANY trade is placed.
...
export function checkRisk(signal, botState, indicators) {
  try {
    ...
    if (hour < 7 || (hour > 18 || (hour === 18 && now.getUTCMinutes() > 5)))
    ...
    if (indicators.atr > indicators.atrAverage * 2)
      return 'SKIP: high volatility / ATR spike';
    ...
    // ── RULE 24: Margin buffer check (Risk check - uses EQUITY/AVAILABLE) ──────
    {

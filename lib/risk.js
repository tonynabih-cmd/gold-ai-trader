...
export function checkRisk(signal, botState, indicators, options = {}) {
  try {
    ...
    if (expectancyKill.active) {
      ...
      const qualityReentryReady = killAgeMs >= EXPECTANCY_KILL_QUALITY_REENTRY_MS && highQualityOverrideTelemetry.highQualityOverride;

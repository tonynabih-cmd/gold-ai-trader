// All candle data fetched from Capital.com — same source as order execution
...
export async function getMarketData(session, botState) {
  try {
    ...
    // 5m candles — full fetch on first run, append latest on subsequent runs
    let candles5m;
    ...
    // 1m candles for momentum confirmation

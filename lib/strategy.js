...
export function generateSignal(indicators, _) {
  try {
    ...
    const priorExpansion =
      action === 'BUY'
        ? (
            (emaSep1 > 0 && emaSep2 > 0 && emaSep3 > 0 && emaSep1 > emaSep2 && emaSep2 > emaSep3) ||
            (emaSep2 > 0 && emaSep3 > 0 && emaSep4 > 0 && emaSep2 > emaSep3 && emaSep3 > emaSep4) ||
            (emaSep3 > 0 && emaSep4 > 0 && emaSep5 > 0 && emaSep3 > emaSep4 && emaSep4 > emaSep5)
          )
        : (
            (emaSep1 < 0 && emaSep2 < 0 && emaSep3 < 0 && emaSep1 < emaSep2 && emaSep2 < emaSep3) ||
            (emaSep2 < 0 && emaSep3 < 0 && emaSep4 < 0 && emaSep2 < emaSep3 && emaSep3 < emaSep4) ||

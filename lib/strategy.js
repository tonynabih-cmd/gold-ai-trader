...
export function generateSignal(indicators, candles1m) {
  try {
    ...
    // BALANCED WIN-RATE UPGRADE: Standards restored to 0.08% (Euro) / 0.10% (US) for better frequency.
    const PULLBACK_SLOPE_THRESHOLD = isEuropeanSession ? 0.08 : 0.10;
    ...
    // BALANCED WIN-RATE UPGRADE: Restored standard RSI blocks for better entry frequency.
    const buyRsiBlock = 70;
    const sellRsiBlock = 30;

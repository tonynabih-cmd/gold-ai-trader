...
export function calculateIndicators(candles5m, candles1h) {
  try {
    ...
    // First value seeds from data[0]; subsequent values compound.
    // First ~period values are warming up — not reliable, but with 100 candles
    // and period=50, the last 50 values are fully reliable.
    ...
    // Uses full OHLC — NOT just close. This is the correct implementation.
    ...
    // Uses (period+1) closes to get (period) differences.

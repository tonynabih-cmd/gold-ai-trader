...
- EMA20 crosses above EMA45 on the current closed candle
...
1.3 * ATR below entry and takeProfit is placed 2.5 * ATR above entry.
\end{lstlisting}
...
1950.00, stop-loss 1947.50, pip value \$1/pip, the function should
return 4.0 lots.
...
from 1.5 to 1.3, improving profit factor from 1.31 to 1.42 at a
cost of 0.4 percentage points of max drawdown.
